...
st.set_page_config(page_title="Walking Analysis", page_icon="🚶", layout="wide")
...
def main():
    ...
    st.header("⚖️ Gait Stability Analysis")
    ...
    if 'WalkingSpeed' in filtered_df.columns:
        ...
        if not speed_data.empty:
            ...
            if avg_speed > 1.2:
                ...
                insights.append("⚠️ **Walking speed below average:** Consider mobility assessment")
    ...
    if 'WalkingAsymmetryPercentage' in filtered_df.columns:
        ...
        if not asymmetry_data.empty:
            ...
            if avg_asymmetry < 0.03:  # 3%
                ...
                insights.append("⚠️ **Elevated asymmetry:** May indicate gait irregularities")
    ...
    if 'WalkingAsymmetryPercentage' in filtered_df.columns:
        ...
        if not asymmetry_data.empty and asymmetry_data.mean() > 0.05:
            recommendations.append("⚖️ **Gait symmetry:** Consider balance exercises to improve walking symmetry")
    ...
    recommendations.append("👩‍⚕️ **Professional consultation:** Discuss significant changes with healthcare provider")

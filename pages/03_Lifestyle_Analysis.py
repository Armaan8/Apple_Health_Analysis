...
def main():
    ...
    st.header("☀️ Daylight Exposure Analysis")
    ...
    if 'TimeInDaylight' in filtered_df.columns:
        ...
        if not daylight_data.empty:
            ...
            insights.append(f"☀️ **Best daylight day:** {max_daylight:.0f} minutes on {max_daylight_date}")
            
            # Daylight recommendations
            if avg_daylight < 30:
                insights.append("🌤️ **Recommendation:** Consider increasing outdoor time for better circadian rhythm")
